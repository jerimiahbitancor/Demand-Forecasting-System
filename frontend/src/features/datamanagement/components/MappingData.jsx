...
const MappingData = () => {
  ...
  const validateForm = () => {
    ...
    if (!newMapping.productName || newMapping.productName.trim() === "") {
      errors.productName = "Product name is required";
      isValid = false;
    }

    // Validate price
    if (!newMapping.price || newMapping.price === "") {
      errors.price = "Price is required";
      isValid = false;
    } else if (isNaN(parseFloat(newMapping.price)) || parseFloat(newMapping.price) <= 0) {
      errors.price = "Price must be a valid number greater than 0";
      isValid = false;
    }

    // Validate category
    if (!newMapping.category || newMapping.category.trim() === "") {
      errors.category = "Category is required";
      isValid = false;
    }

    // Validate ingredients
    if (newMapping.ingredients.length === 0) {
  ...
  const handleSaveMapping = async () => {
    ...
    try {
      const payload = {
        name: newMapping.productName.trim(),
        price: parseFloat(newMapping.price),
        category: newMapping.category.trim(),
        serving_size_label: newMapping.servingSize || null,
        ingredients: newMapping.ingredients.map(ing => ({
          name: ing.name.trim(),
  ...
  const handleAddIngredient = () => {
    ...
    const duplicate = newMapping.ingredients.some(
    ...
    setNewMapping({
      ...newMapping,
      ingredients: [...newMapping.ingredients, { 
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      setNewMapping({...newMapping, price: e.target.value});
                      if (formErrors.price) {
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    value={newMapping.servingSize}
                    onChange={(e) => setNewMapping({...newMapping, servingSize: e.target.value})}
                  />
                </div>
              </div>
